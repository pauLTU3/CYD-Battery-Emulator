// pauLTU3
// Wi-Fi, AP setup and OTA web server for the CYD screen.
...
// Keep AP on channel 1 for ESP-NOW compatibility.
...
String recovery_page(const __FlashStringHelper *title,
    ...
    page += F("</title>");
    page += F("<style>"
              "body{font-family:Arial,sans-serif;background:#0f1115;color:#e8eaed;margin:0;padding:18px;}"
              ".wrap{max-width:680px;margin:48px auto;}"
              ".card{background:#171a21;border:1px solid #303642;border-radius:12px;padding:18px;}"
              "a{color:#64b5f6;font-weight:700;}code{background:#222833;color:#e8eaed;padding:2px 6px;border-radius:6px;}"
...
void handle_root() {
    ...
    page += F("<style>"
              ...
              ".card{background:#171a21;border:1px solid #303642;border-radius:12px;padding:16px;margin-bottom:16px;}"
              "h1,h2{margin:0 0 12px 0;}label{display:block;font-weight:700;margin-top:10px;}"
              "input{width:100%;box-sizing:border-box;padding:10px;margin-top:6px;border:1px solid #46505e;border-radius:8px;background:#0f1115;color:#e8eaed;}"
    ...
    page += F("<div class=\"note\"><strong>ESP-NOW:</strong> The CYD screen and Battery Emulator must be connected to the same Wi-Fi network. Otherwise ESP-NOW may not work or may be unstable.</div>");
